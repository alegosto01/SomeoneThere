...
| Uniplaces | Student housing marketplace | Marketplace verification of internal listings | External listings not covered |
| Flatio | Mid-term rental marketplace | Marketplace with standardized listings | No independent external verification |
| Idealista | Listings portal | Large listing inventory; some verification | Bring-your-own-listing check not offered |
| Airtasker / Taskrabbit | General task platforms | General gig tasks including occasional property visits | Not specialized, weak trust/safety for this use case |
...
- Evidence + risk indicators, not a guarantee.
- Manual, permission-first operations before marketplace.

## Revisit when

After user interviews and pricing tests, refine this map and validate which competitor gap customers value most.
