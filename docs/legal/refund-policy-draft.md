...
This is a draft for lawyer review before card payments launch. It is not legal advice.
...
The default MVP rule is no refund after the verification report is delivered, because the service has been rendered. This clause needs Spanish lawyer review before launch.
...
- Delivery channel, such as email or signed link.
- Report version delivered.

Retention should follow the privacy policy and data-retention schedule.
