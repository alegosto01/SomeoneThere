# Landlord Data Legitimate-Interest Assessment Draft

This is a draft for Spanish GDPR lawyer review. It does not establish legal certainty.
...
## Proposed lawful basis to review

The proposed lawful basis for internal processing is legitimate interest under GDPR Article 6(1)(f). A lawyer must confirm whether this basis is valid for non-consenting landlord or agent identity data.
...
- Pseudonymize landlord/agent identity in the customer-facing report.
- Keep real names/contact details internal for QA only where needed.
- Do not publish reports.
- Do not label any person as a scammer, fraudster, or criminal.
- Use observed-fact wording and unresolved-concern wording.
- Set a short retention period unless payment, dispute, or legal needs require longer retention.
